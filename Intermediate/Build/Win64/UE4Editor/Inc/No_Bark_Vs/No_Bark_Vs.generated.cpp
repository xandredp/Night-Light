...
static struct FScriptStruct_No_Bark_Vs_StaticRegisterNativesFCraftingInfo
{
	...
	{
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "AddItemtoEquipmentByItem",(Native)&APlayController::execAddItemtoEquipmentByItem);
		...
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "AttachEquipment",(Native)&APlayController::execAttachEquipment);
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "AttachEquipmenttoCharacter",(Native)&APlayController::execAttachEquipmenttoCharacter);
		...
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "OpenMap",(Native)&APlayController::execOpenMap);
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "ReArrangeItems",(Native)&APlayController::execReArrangeItems);
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "RemoveItemFromEquipment",(Native)&APlayController::execRemoveItemFromEquipment);
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "RemoveItemFromInventory",(Native)&APlayController::execRemoveItemFromInventory);
		...
		FNativeFunctionRegistrar::RegisterFunction(APlayController::StaticClass(), "UnAttachEquipment",(Native)&APlayController::execUnAttachEquipment);
...
// Cross Module References
	...
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_AttachEquipment();
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_AttachEquipmenttoCharacter();
	...
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_OpenMap();
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_ReArrangeItems();
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_ReloadInventory();
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_RemoveItemFromEquipment();
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_RemoveItemFromInventory();
	...
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_APlayController_UnAttachEquipment();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	uint32 Get_Z_Construct_UEnum_No_Bark_Vs_EItemType_CRC() { return 1930339058U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UFunction* Z_Construct_UFunction_APlayController_AddItemtoEquipmentByItem()
	{
		struct PlayController_eventAddItemtoEquipmentByItem_Parms
		{
			FCurrentInventoryItemInfo iItemtoAdd;
			int32 toIndex;
		};
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AddItemtoEquipmentByItem"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventAddItemtoEquipmentByItem_Parms));
			UProperty* NewProp_toIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("toIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(toIndex, PlayController_eventAddItemtoEquipmentByItem_Parms), 0x0010000000000080);
			UProperty* NewProp_iItemtoAdd = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("iItemtoAdd"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(iItemtoAdd, PlayController_eventAddItemtoEquipmentByItem_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_AddItemtoInventoryByID()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_ItemCurrentStackNumber = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemCurrentStackNumber"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(ItemCurrentStackNumber, PlayController_eventAddItemtoInventoryByID_Parms), 0x0010000000000080);
	...
	UFunction* Z_Construct_UFunction_APlayController_AttachEquipment()
	{
		struct PlayController_eventAttachEquipment_Parms
		{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AttachEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventAttachEquipment_Parms));
			UProperty* NewProp_iItemInfo = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("iItemInfo"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(iItemInfo, PlayController_eventAttachEquipment_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_AttachEquipmenttoCharacter()
	{
		struct PlayController_eventAttachEquipmenttoCharacter_Parms
		{
			FCurrentInventoryItemInfo ItemToAttech;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("AttachEquipmenttoCharacter"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventAttachEquipmenttoCharacter_Parms));
			UProperty* NewProp_ItemToAttech = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemToAttech"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ItemToAttech, PlayController_eventAttachEquipmenttoCharacter_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_DetachEquipmentfromCharacter()
	{
		struct PlayController_eventDetachEquipmentfromCharacter_Parms
		{
			FCurrentInventoryItemInfo ItemToDetach;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("DetachEquipmentfromCharacter"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventDetachEquipmentfromCharacter_Parms));
			UProperty* NewProp_ItemToDetach = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemToDetach"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ItemToDetach, PlayController_eventDetachEquipmentfromCharacter_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_DropItem()
	{
	...
	UFunction* Z_Construct_UFunction_APlayController_MoveItemToInventory()
	{
		struct PlayController_eventMoveItemToInventory_Parms
		{
			FCurrentInventoryItemInfo iItemFromEqupment;
			int32 ItemBIndex;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MoveItemToInventory"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventMoveItemToInventory_Parms));
			UProperty* NewProp_ItemBIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemBIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(ItemBIndex, PlayController_eventMoveItemToInventory_Parms), 0x0010000000000080);
			UProperty* NewProp_iItemFromEqupment = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("iItemFromEqupment"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(iItemFromEqupment, PlayController_eventMoveItemToInventory_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_MoveItemWithinInventory()
	{
		struct PlayController_eventMoveItemWithinInventory_Parms
		{
			int32 ItemAIndex;
			int32 ItemBIndex;
		};
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MoveItemWithinInventory"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventMoveItemWithinInventory_Parms));
			UProperty* NewProp_ItemBIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemBIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(ItemBIndex, PlayController_eventMoveItemWithinInventory_Parms), 0x0010000000000080);
			UProperty* NewProp_ItemAIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemAIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(ItemAIndex, PlayController_eventMoveItemWithinInventory_Parms), 0x0010000000000080);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_OpenMap()
	{
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OpenMap"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_ReArrangeItems()
	{
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ReArrangeItems"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535);
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_RemoveItemFromEquipment()
	{
		struct PlayController_eventRemoveItemFromEquipment_Parms
		{
			FCurrentInventoryItemInfo ItemtoRemove;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RemoveItemFromEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventRemoveItemFromEquipment_Parms));
			UProperty* NewProp_ItemtoRemove = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemtoRemove"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ItemtoRemove, PlayController_eventRemoveItemFromEquipment_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_RemoveItemFromInventory()
	{
		struct PlayController_eventRemoveItemFromInventory_Parms
		{
			FCurrentInventoryItemInfo ItemToRemove;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RemoveItemFromInventory"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventRemoveItemFromInventory_Parms));
			UProperty* NewProp_ItemToRemove = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("ItemToRemove"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(ItemToRemove, PlayController_eventRemoveItemFromInventory_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UFunction* Z_Construct_UFunction_APlayController_UnAttachEquipment()
	{
		struct PlayController_eventUnAttachEquipment_Parms
		{
			FCurrentInventoryItemInfo iItemInfo;
		};
		UObject* Outer=Z_Construct_UClass_APlayController();
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("UnAttachEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04020401, 65535, sizeof(PlayController_eventUnAttachEquipment_Parms));
			UProperty* NewProp_iItemInfo = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("iItemInfo"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(iItemInfo, PlayController_eventUnAttachEquipment_Parms), 0x0010000000000080, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_APlayController()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_AddItemtoEquipmentByItem());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_AddItemtoInventoryByID());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_AttachEquipment());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_AttachEquipmenttoCharacter());
				...
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_OpenMap());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_ReArrangeItems());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_ReloadInventory());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_RemoveItemFromEquipment());
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_RemoveItemFromInventory());
				...
				OuterClass->LinkChild(Z_Construct_UFunction_APlayController_UnAttachEquipment());
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_MyMapWidget = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MyMapWidget"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(MyMapWidget, APlayController), 0x0010000000000005, Z_Construct_UClass_UUserWidget_NoRegister());
				...
				UProperty* NewProp_wMinimap = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("wMinimap"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(wMinimap, APlayController), 0x0014000000000005, Z_Construct_UClass_UUserWidget_NoRegister(), UClass::StaticClass());
				...
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(isMyMapOpen, APlayController, bool);
				UProperty* NewProp_isMyMapOpen = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("isMyMapOpen"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(isMyMapOpen, APlayController), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(isMyMapOpen, APlayController), sizeof(bool), true);
				...
				UProperty* NewProp_WeaponClass = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WeaponClass"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(WeaponClass, APlayController), 0x0014000000010001, Z_Construct_UClass_ABaseWeapon_NoRegister(), UClass::StaticClass());
				UProperty* NewProp_iItemRemovedfromEquipment = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("iItemRemovedfromEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(iItemRemovedfromEquipment, APlayController), 0x0010000000000005, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
				UProperty* NewProp_MaxEquipmentSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxEquipmentSize"), RF_Public|RF_Transient|RF_MarkAsNative) UUnsizedIntProperty(CPP_PROPERTY_BASE(MaxEquipmentSize, APlayController), 0x0010000000000005);
				UProperty* NewProp_FCurrentEquipment = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FCurrentEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(FCurrentEquipment, APlayController), 0x0010000000020005);
				UProperty* NewProp_FCurrentEquipment_Inner = new(EC_InternalUseOnlyConstructor, NewProp_FCurrentEquipment, TEXT("FCurrentEquipment"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000020000, Z_Construct_UScriptStruct_FCurrentInventoryItemInfo());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_AddItemtoEquipmentByItem(), "AddItemtoEquipmentByItem"); // 1210253997
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_AddItemtoInventoryByID(), "AddItemtoInventoryByID"); // 764917317
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_AttachEquipment(), "AttachEquipment"); // 2277610400
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_AttachEquipmenttoCharacter(), "AttachEquipmenttoCharacter"); // 1204597511
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_OpenMap(), "OpenMap"); // 335713765
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_ReArrangeItems(), "ReArrangeItems"); // 1249522098
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_RemoveItemFromEquipment(), "RemoveItemFromEquipment"); // 2397295253
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_RemoveItemFromInventory(), "RemoveItemFromInventory"); // 1185420748
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_APlayController_UnAttachEquipment(), "UnAttachEquipment"); // 483353303
				...
				MetaData->SetValue(NewProp_MyMapWidget, TEXT("Category"), TEXT("Widgets"));
				MetaData->SetValue(NewProp_MyMapWidget, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				...
				MetaData->SetValue(NewProp_wMinimap, TEXT("Category"), TEXT("Widgets"));
				MetaData->SetValue(NewProp_wMinimap, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				...
				MetaData->SetValue(NewProp_isMyMapOpen, TEXT("Category"), TEXT("Status"));
				MetaData->SetValue(NewProp_isMyMapOpen, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				...
				MetaData->SetValue(NewProp_WeaponClass, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				MetaData->SetValue(NewProp_WeaponClass, TEXT("ToolTip"), TEXT("Class to add to SpawnLocation when picked up"));
				MetaData->SetValue(NewProp_iItemRemovedfromEquipment, TEXT("Category"), TEXT("Widgets"));
				MetaData->SetValue(NewProp_iItemRemovedfromEquipment, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				MetaData->SetValue(NewProp_MaxEquipmentSize, TEXT("Category"), TEXT("Widgets"));
				MetaData->SetValue(NewProp_MaxEquipmentSize, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				MetaData->SetValue(NewProp_FCurrentEquipment, TEXT("Category"), TEXT("PlayController"));
				MetaData->SetValue(NewProp_FCurrentEquipment, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
				MetaData->SetValue(NewProp_FCurrentEquippedMeleeWeapon, TEXT("Category"), TEXT("PlayController"));
				MetaData->SetValue(NewProp_FCurrentEquippedMeleeWeapon, TEXT("ModuleRelativePath"), TEXT("PlayController.h"));
