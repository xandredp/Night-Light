...
FName NO_BARK_VS_Interact = FName(TEXT("Interact"));
FName NO_BARK_VS_OnUsed = FName(TEXT("OnUsed"));
	void ABaseInteractable::Interact(APlayerController* playerController)
	{
		BaseInteractable_eventInteract_Parms Parms;
		Parms.playerController=playerController;
		ProcessEvent(FindFunctionChecked(NO_BARK_VS_Interact),&Parms);
	}
	...
	IMPLEMENT_CLASS(ABaseInteractable, 631909119);
...
static struct FScriptStruct_No_Bark_Vs_StaticRegisterNativesFWeaponData
{
	...
	IMPLEMENT_CLASS(ABaseWeapon, 4288510529);
	void APickup::OnUsed()
	{
		ProcessEvent(FindFunctionChecked(NO_BARK_VS_OnUsed),NULL);
	}
	...
	IMPLEMENT_CLASS(APickup, 317691130);
	void APickupHealth::StaticRegisterNativesAPickupHealth()
	{
	}
	IMPLEMENT_CLASS(APickupHealth, 3628032348);
...
static struct FScriptStruct_No_Bark_Vs_StaticRegisterNativesFCraftingInfo
{
	...
	IMPLEMENT_CLASS(ANBCharacter, 4120223855);
	...
	IMPLEMENT_CLASS(APlayController, 1249466143);
...
// Cross Module References
	...
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_ABaseInteractable_Interact();
	...
	NO_BARK_VS_API class UFunction* Z_Construct_UFunction_ABaseWeapon_OnUsed();
	...
	UFunction* Z_Construct_UFunction_ABaseInteractable_Interact()
	{
		UObject* Outer=Z_Construct_UClass_ABaseInteractable();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Interact"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x08020800, 65535, sizeof(BaseInteractable_eventInteract_Parms));
			UProperty* NewProp_playerController = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("playerController"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(playerController, BaseInteractable_eventInteract_Parms), 0x0010000000000080, Z_Construct_UClass_APlayerController_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_ABaseInteractable()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_ABaseInteractable_Interact());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABaseInteractable_Interact(), "Interact"); // 201678190
	...
	UFunction* Z_Construct_UFunction_ABaseWeapon_OnUsed()
	{
		UObject* Outer=Z_Construct_UClass_ABaseWeapon();
		static UFunction* ReturnFunction = NULL;
		if (!ReturnFunction)
	...
	UClass* Z_Construct_UClass_ABaseWeapon()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->LinkChild(Z_Construct_UFunction_ABaseWeapon_OnUsed());
				OuterClass->LinkChild(Z_Construct_UFunction_ABaseWeapon_ProjectileFire());

PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ItemID = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ItemID"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(ItemID, ABaseWeapon), 0x0020080000000005);
				...
				UProperty* NewProp_WeaponMesh = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WeaponMesh"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WeaponMesh, ABaseWeapon), 0x00100000000a001d, Z_Construct_UClass_USkeletalMeshComponent_NoRegister());
				UProperty* NewProp_CollisionComp = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CollisionComp"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(CollisionComp, ABaseWeapon), 0x00100000000a001d, Z_Construct_UClass_UBoxComponent_NoRegister());
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_ABaseWeapon_OnUsed(), "OnUsed"); // 3272210918
				...
				MetaData->SetValue(NewProp_ItemID, TEXT("ModuleRelativePath"), TEXT("BaseWeapon.h"));
				...
				MetaData->SetValue(NewProp_CollisionComp, TEXT("Category"), TEXT("Collision"));
				MetaData->SetValue(NewProp_CollisionComp, TEXT("EditInline"), TEXT("true"));
				MetaData->SetValue(NewProp_CollisionComp, TEXT("ModuleRelativePath"), TEXT("BaseWeapon.h"));
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_ItemID = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ItemID"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(ItemID, APickup), 0x0020080000000005);
				UProperty* NewProp_PickupMesh = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PickupMesh"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(PickupMesh, APickup), 0x0020080000080009, Z_Construct_UClass_UStaticMeshComponent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
